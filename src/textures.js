...
//asadullah nadeeem
        ...
        this._LoadType(
          'dirt',
          [ 'resources/minecraft/textures/blocks/dirt.ico' ],
...
//asadullah nadeeem
        ...
        this._LoadType(
          'ocean',
          [ 'resources/minecraft/textures/blocks/sand.ico' ],
          new THREE.Vector2( 1.0, 4.0 ),
          [ new THREE.Color( 1.0, 1.0, 1.0 ), new THREE.Color( 1.0, 1.0, 1.0 ) ]
        );
//asadullah nadeeem
        ...
        this._LoadType(
          'stone',
          [ 'resources/minecraft/textures/blocks/stone.ico' ],
          new THREE.Vector2( 1.0, 4.0 ),
          [ new THREE.Color( 1.0, 1.0, 1.0 ), new THREE.Color( 1.0, 1.0, 1.0 ) ]
        );//asadullah nadeeem
//asadullah nadeeem
        ...
        this._LoadType(
          'leaves_spruce',
          [ 'resources/minecraft/textures/blocks/leaves_spruce_opaque.ico' ],
          new THREE.Vector2( 1.0, 4.0 ),
          [ new THREE.Color( 1.0, 1.0, 1.0 ), new THREE.Color( 1.0, 1.0, 1.0 ) ]
        );
